...
a discontinuous Galerkin (DG) finite element method with upwinding in space to accurately capture sharp boundary layers. We remark that the transport in the CSF spaces is highly convection dominated, with an average Péclet number of 402 and maximum of 9542 (assuming a characteristic length of $10\,$cm and taking the increased diffusivity due to dispersion into account).
...
\begin{tabular}{c|c|c|c|c}
    \toprule
   quantity of interest  & Watts et al\cite{watts2019measuring}  & Ringstad et al\cite{ringstad2018brain} & Eide and Ringstand \cite{eide2024functional} & ours (vasomotion model)\\
   \midrule
    Spinal transit time &  1 - 3 hours & 20 min &  $13\pm6.3\,$ min & N/A \\
    Time of peak amount (CSF) & 10 - 15 hours & 6–9 hours & & 2 hours \\
    ...
    FTA in MCA1 & N/A & N/A &  37.8 ± 47.0 min &  1:48 / 1:24 hours \\
    FTA in MCA2 & N/A & N/A & 53.1 ± 50.5 min & 2:12 / 1:48 hours \\
    FTA in ACA2 & N/A & N/A & 48.3 ± 46.1 min & 3:00 / 3:12 hours \\
    \bottomrule
\end{tabular}
\caption{Comparison of literature values and model predictions on overall tracer spreading patters and timing}
\label{tab:spreading comparison}
\end{table}
