...
In terms of domains, interfaces and boundaries, we consider the
parenchyma $\Omega_{\rm PAR} \subset \R^3$ and CSF spaces $\Omega_{\rm
  CSF} \subset \R^3$ with $\Omega = \Omega_{\rm PAR} \cup \Omega_{\rm
  CSF}$. The interface between the parenchyma and CSF spaces is
decomposed
