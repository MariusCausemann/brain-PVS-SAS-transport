...
(-D \nabla (\phi c) + \bm u c ) \cdot \bm{n} & = 0  &&  \quad  \mathrm{on} \quad \Gamma_{\rm AM-L} \discuss{\cup \Gamma_{\rm SC}}  .
\end{alignat} 
...
\subsection{Cardiac Dispersion Factor Estimation}
...
\subsubsection{Cardiac Dispersion Factor Estimation}\label{sec:dispersion_details}
