...
\end{equation}
Since $\bm V_h \subset H(\mathrm{div}, \Omega_{\rm CSF})$, then $[\bm v_n] = 0 $ on $\mathcal{F}_{\rm CSF}$. Continuity in the tangential component is enforced weakly via interior penalization. Define the form \mer{MER: Check $\Gamma_{\rm AM}$ part. 26.11.24: Rami will check $\mathcal{F}_e$ versus definitions of the boundaries and where it appears.}
\begin{multline}
