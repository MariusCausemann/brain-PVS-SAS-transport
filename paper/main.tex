...
efflux across the outer cavity\cite{hornkjol2022csf} and the
peristaltic pumping effect of cardiac arterial
pulsations\cite{mestre2018flow,
  gjerde2023directional}. Mathematically, this model is represented by
a mixed-dimensional system of coupled time-dependent partial
...
appears in the CSF space at the craniocervical junction. What we observe. 
\begin{figure}
    \centering
