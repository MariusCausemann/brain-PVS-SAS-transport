...
though CSF flowmetry techniques that can measure slow flow in the SAS,
e.g.~on the order of hundreds of $\mu$m/s, are beginning to
...
0.1Hz, a wavelength of 20 mm, and an inner wall displacement of up to
10\% -- in the antegrade direction, all values currently associated
with major uncertainty~\cite{gokina1996electrical,
