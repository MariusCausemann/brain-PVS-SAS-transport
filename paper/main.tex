...
\begin{abstract}
  ...
  a solute within an image-derived geometric representation of the
  ...
  enrichment, and that impaired enrichment is a natural direct
  consequence of enlarged PVSs. This openly available technology
  platform thus provides an opportunity for integrating separate
  observations on diffusion in neuropil, vascular dynamics,
  intracranial pulsatility, CSF production, and efflux, and for
  exploring questions relating to drug delivery and clearance in the
