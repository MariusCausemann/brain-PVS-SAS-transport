...
\includegraphics[width = 1 \textwidth]{paper/figures/subdomains.png}
\caption{3D model of SAS and ventricles}
\label{fig:csf_flow_geom}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/boundaries.png}
...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/csf_velocity_histo.png} 
\caption{production-induced flow velocities}
\label{fig:csf_flow_histo}
\end{subfigure}
