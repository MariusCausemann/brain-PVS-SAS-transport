...
\subsection*{Vascular and perivascular domains and network}
...
represented as graphs with nodes connected by edges. The nodes with
lowest z-coordinate are identified as the networks' root
nodes. \mer{The arterial network has consists of 3 subnetworks, with
  XXX nodes and YYY edges in total. The venous network consists of 50
  subnetworks, with XXX nodes and YYY edges in total.} We denote the
