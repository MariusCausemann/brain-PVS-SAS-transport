...
with permeability coefficient $\beta_{\rm pia}$. For an extended description of the mathematical model and simulation
scenarios, see the Supplementary information S1. The initial
