...
a greater extent. \discuss{With a small delay, more tracer appears via
  ...
  difference).} At the anterior cerebral artery (ACA-2), the first tracer arrival in the PVS occurs after 3 hours, with a peak at 5 hours. The peak in the PVS is tailed by a higher peak in the CSF (\Cref{fig:compartmentalization}E), indicating tracer arrival through a second pathway; i.e., directly through the CSF-filled space outside of the PVS. Similar patterns are observed for ACA-A3.
