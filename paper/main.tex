...
spaces (see Methods, \Cref{fig:results1}B--C, \fixme{Figure SX}).  To
model the convective flow field, we impose a constant CSF inflow of
$400$ mL/day at the lateral ventricle surfaces, representing the
average daily physiological CSF production rate
...
solute transport time scale of hours, we estimate
