...
consider separate flow models in the CSF and PVS, without coupling.
\begin{figure}
    \centering
...
Next, a natural question is how such variations in the net
...
Summarizing and quantifying these model observations
...
these domains. Thus, in our model, fast transport along the PVS is not
