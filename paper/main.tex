...
\begin{subfigure}{0.5 \linewidth}
    \centering
    \includegraphics[width=1\linewidth]{paper/figures/modelA_conc_at_label.png}
    \caption{B1 - $\xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB1-10_conc_at_label.png}
    \caption{B1 - $10 \xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB1-100_conc_at_label.png}
    \caption{B1 - $100 \xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB1-1000_conc_at_label.png}
    \caption{B1 - $1000 \xi$}
\end{subfigure}
\begin{subfigure}{0.5 \linewidth}
    \centering
    \includegraphics[width=1\linewidth]{paper/figures/modelB2-1_conc_at_label.png}
    \caption{B2 - $\xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB2-10_conc_at_label.png}
    \caption{B2 - $10 \xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB2-100_conc_at_label.png}
    \caption{B2 - $100 \xi$}
    \includegraphics[width=1\linewidth]{paper/figures/modelB2-1000_conc_at_label.png}
    \caption{B2 - $1000 \xi$}
\end{subfigure}
...
%% represented as graphs with nodes connected by edges. 

%The resulting vascular networks are further smoothened using a spline
