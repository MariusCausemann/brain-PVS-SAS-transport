...
\subsection*{In-silico tracer distribution patterns are sensitive to the balance between convection and dispersion in the CSF spaces}
...
differ substantially between subjects and between pathological
...
subject and between physiological states. 
 
We therefore next asked to what extent -- and
how -- variations in CSF pulsatility would affect the intracranial
spread of tracer.
...
Now, to examine how CSF pulsatility affects the tracer distribution patterns,
