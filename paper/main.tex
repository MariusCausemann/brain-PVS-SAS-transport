...
of \mar{intracranial molecular enrichment and clearance}. Focusing on the
...
\subsection*{In-silico predictions of intracranial \mar{molecular enrichment and clearance} after intrathecal injection}
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{figures/figure1.png}
     \caption{
     \textbf{In-silico modelling of \mar{molecular enrichment and clearance} of the PVS, SAS and parenchyma.}
...
velocity in the SAS of $2.6$\textmu m/s (\Cref{fig:csf}E). 
To examine the dispersive effects of pulsatile CSF flow, we employ the theory of
...
CSF pressure and flow fields at peak systolic blood inflow. Modelling the reduction 
in CSF space volume corresponding to peak systolic conditions, we assume a
total inflow rate of $6\,$ml/s~\cite{baledent2014imaging, causemann2022human} 
in the SAS across its outer surface and $0.31\,$ml/s across the lateral ventricle surface\cite{vinje2019respiratory}. This scenario sets up a pressure drop of 
$10\,$Pa ($0.075$ mmHg) between the lateral ventricles and the spinal 
SAS and a maximum flow velocity of $19.8\,$cm/s (\Cref{fig:csf}F, J). 
Assuming a cardiac frequency of $1\,$Hz, we infer that this cardiac-induced 
pulsatile CSF flow increases the
...
%% Summary of findings
We have presented a high-fidelity in-silico model of \mar{molecular
...
mean flow rate (see Supplementary information S1.4 for more details). Two
