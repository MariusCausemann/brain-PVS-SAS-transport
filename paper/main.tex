...
function. \textcolor{lightgray}{Moreover, altered transport and
  clearance is believed to be key factor in neurodegenerative diseases
  like Alzheimer's disease and Parkinson's disease, and in sleep. For
  diagnostics of CSF-related disorders like normal pressure
  hydrocephalus, subarachnoid hemorrage. The context of understanding
  clearance in connection with neurodegenerative disease and for
  future treatment and diagnostics of dementia disorders.
  Understanding and predicting molecular enrichment is important for
  treatment and diagnostics of (brain) cancer.} In the last decade,
...
exchange~\cite{iliff2012paravascular, ringstad2017glymphatic,
  ...
  bohr2022glymphatic}, together with substantial variability in
...
intrathecal delivery of chemotherapy~\cite{lohela2022glymphatic}, or
for early diagnostics of impaired brain
clearance~\cite{eide2021clinical,
  ...
  challenges relating to the transfer of knowledge between species,
  experiments, cohorts, individual variations}
