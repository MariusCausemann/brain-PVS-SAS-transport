...
\includegraphics[width = 1 \textwidth]{paper/figures/CSF flow & dispersion.png}
...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/prod_velocity_histo.png} 
\caption{production-induced flow velocities}
\label{fig:csf_flow_histo_prod}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/cardiac_velocity_histo.png} 
\caption{cardiac-induced flow velocities}
\label{fig:csf_flow_histo_cardiac}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/R_histo.png} 
\caption{dispersion enhancement factor $R$}
...
\begin{figure}
    ...
    \centering
    \includegraphics[width = \linewidth]{paper/figures/labeled_arteries.png}
    \end{subfigure}
     \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/vasomotion_arteries_labels_length.png}
    \includegraphics[width =  \linewidth]{paper/figures/vasomotion_arteries_labels_radius.png}
    \end{subfigure}
     \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/vasomotion_velocity_histo_cell.png}
    \caption{Vasomotion}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/vasomotion_arteries_labels_velocity.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/sas_flow_arteries_labels_pressure.png}
    \end{subfigure}
         \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/cardiac_pvs_oscillation_velocity_histo_cell.png}
    \caption{Cardiac peristaltic flow}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/cardiac_pvs_oscillation_arteries_labels_velocity.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/sas_flow_arteries_labels_pressure.png}
    \end{subfigure}
         \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/sas_flow_velocity_histo_cell.png}
    \caption{Production induced flow}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/sas_flow_arteries_labels_velocity.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
    \centering
    \includegraphics[width =  \linewidth]{paper/figures/sas_flow_arteries_labels_pressure.png}
