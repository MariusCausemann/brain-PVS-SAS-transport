...
% We now turn to focus on the perivascular spaces.
...
clearance\cite{}. However, whether and to what extent CSF flows more
rapidly in PVSs; and if so, what its underlying driving forces are,
remain as points of debate~\cite{bohr2022glymphatic,
  van2024caa}. \textcolor{lightgray}{Largely motivated by intriguing
  experimental observations in animal models, there is now a
  remarkable body of modelling literature identifying and classifying
  the mechanisms underlying net and pulsatile flow of CSF in
  perivascular spaces, pointing at X, Y, Z. Here, we ask what the
  integrated effect of these mechanisms would be -- in the human
  setting -- and to what extent clinical observations would rely on
  rapid PVS transport?} \mer{WIP here.}
