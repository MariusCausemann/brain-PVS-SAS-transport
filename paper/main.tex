...
\begin{figure}
    ...
    G) concentration in the PVS and mean concentration on the outer PVS surface over time an selected segments of the arterial tree for the baseline and high PVS flow models;
    }
    \label{fig:pvs}
\end{figure}
