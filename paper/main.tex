...
The pulsatile flow of CSF in the SAS and ventricular system associated
with with the cardiac and respiratory cycles enhances molecular
diffusion through dispersion~\cite{taylor1953dispersion,
  watson1983diffusion, asgari2016glymphatic, keith2019dispersion,
  ray2021quantitative, troyetsky2021dispersion}. In $\Omega_{\rm
  CSF}$, we compute a spatially-varying dispersion factor $R$ by
combining a computational model of cardiac-induced CSF flow at peak
arterial dilation (peak systole) with theoretical estimates for
shear-augmented (Taylor) dispersion \cite{taylor1953dispersion,
  watson1983diffusion, keith2019dispersion}.
