...
elsewhere. The effective diffusion coefficient is set equal to that of
...
permeability $\xi$ ($100\times$) \fixme{near} the leaf nodes of $\Lambda_a$ to
...
numerical verification experiments (see \Cref{sec:app:verification}).
