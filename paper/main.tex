...
Hornkjøl et al \cite{hornkjol2022csf} model CSF flow induced by production in the choroid plexus and report a peak velocity of $8.9\,$mm/s in the aqueduct. Given that similar flow rates were enforced, the deviation from our value of $2.0\,$mm/s is likely due to differences in diameter of the reconstructed aqueduct. Additionally, their peak velocities in the SAS range between 20 - 50 \textmu m/s, which is compatible with our mean velocity of 4.4 \textmu m/s (\Cref{fig:csf_flow_histo}).
...
the order of 1-10 \textmu/min) in humans \cite{vinje2023human} and cats
