...
\item
  ...
  dispersive effects on tracer trajectories, flow bifurcation.
\item
...
\begin{figure}
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{paper/figures/Brain-PVS-callouts.png}
     \end{subfigure}
     \hfill
...
We construct a 3D model of the SAS and the ventricular system (\Cref{fig:csf_flow_geom}) and compute CSF flow fields for three different scenarios: CSF production in the choroid plexus, CSF flow at systolic peak blood inflow and CSF flow in response to free breathing.
...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/csf_v_prod.png}
...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/csf_v_respiratory.png}
\includegraphics[width = 1 \textwidth]{paper/figures/resp_velocity_histo.png} 
\caption{CSF flow  from respiratory pulsatility}
\label{fig:csf_flow_respiratory}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/R_cardiac.png} 
\caption{Cardiac dispersion enhancement factor}
\label{fig:csf_flow_R_cardiac}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/R_respiratory.png} 
\caption{Respiratory dispersion enhancement factor}
\label{fig:csf_flow_R_respiratory}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{paper/figures/cardiac_R_histo.png}
\includegraphics[width = 1 \textwidth]{paper/figures/respiratory_R_histo.png} 
...
In contrast to the CSF space, pulsatile mixing plays a negligible role in the PVS
\begin{itemize}
    \item \cite{asgari2016glymphatic}
    \item \cite{troyetsky2021dispersion}
    \item \cite{keith2019dispersion}
\end{itemize}
