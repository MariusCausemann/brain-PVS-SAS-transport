...
\begin{figure}[h!]
    \centering 
\includegraphics[scale=0.1]{paper/figures/g_visualize.png}
...
\subsection{Cerebrospinal fluid flow in the perivascular spaces}  \label{sec:csf_pvs}
...
\subsection{Fluid flow within the parenchyma} \label{sec:csf_brain}
