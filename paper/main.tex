...
representation of human intracranial compartments consisting of the
CSF spaces and brain parenchyma as 3D domains and with the PVSs
surrounding major surface arteries and veins as networks of
topologically 1D curves embedded within the SAS
(\Cref{fig:results1}A--C, Methods). In order to investigate the

Within these spaces, we study a solute concentration that can
distribute within

~\cite{masri2024modelling}

We model a solute concentration within the 3D domains and an averaged



Solute concentration (Gadubutrol) in the 3D volumes and concent


Within these spaces, a solute concentration will experience (i)
hindered diffusion depending on the diffusivity of the solute and the
effective properties of the medium\cite{sykova2008diffusion}; (ii)
dispersive effects induced by pulsatile flow of CSF; (iii) 

Within these spaces, a solute concentration
will experience (i) hindered diffusion depending on the diffusivity of
the solute and the effective properties of the medium; (ii) the
dispersive effects induced by pulsatile flow in the CSF spaces 

; (ii) the dispersive effects of pulsatile CSF flow in the SAS induced
by the cardiac and respiratory effects, (iii) net CSF flow induced by
pressure differences in the bulk spaces and the PVSs induced by CSF
production in the choroid plexues with CSF efflux across the outer
cavity, and net PVS flow induced by peristaltic pumping.

The distribution and evolution of a solute concentration within these
spaces is

Solute transport within these spaces is  

hypothesized to be modulated by at least four major physical and
physiological factors:

Integrating observations from clinical, experimental and computationl
studies

hypothesized to be modulated by at least four major physical and
physiological factors:

and partial differential equations~\cite{masri2024modelling}
...
and evolution of solute within these spaces:
