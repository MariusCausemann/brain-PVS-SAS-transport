...
\begin{figure}
    ...
    \includegraphics[width=0.98\textwidth]{figures/figure1.png}
     ...
     F) total amount of tracer in each cranial compartment over the first 24\,h; 
     G) average tracer concentration in each compartment over the first 24\,h. }
     \label{fig:results1}
\end{figure}
...
(\Cref{fig:results1}G). While the mean concentrations in these
