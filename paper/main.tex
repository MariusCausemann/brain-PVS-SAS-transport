...
\item
  ...
  \end{itemize}
\item
  Shapes and sizes of the perivascular spaces
  \begin{itemize}
\item
  Schain et al~\cite{schain2017cortical} report on the sizes of pial arteries ($6.0-11 \mu$m in radius or diameter!) and veins ($9.4-21\mu$m) in mice, with an average PVS/lumen area ratio of $1.26$ for arteries and $0.13$ for veins.  
  \item
...
\item
  ...
  of perivascular spaces surrounding pial arteries in mice. 
\item
...
\item Mestre et al~\cite{mestre2018flow} measure and characterize pial perivascular transport and estimate flow magnitudes in mice. They report a PVS/lumen area ratio of $1.4 \pm 0.1$ and a PVS width of $\approx 40 \mu$m which described as comparable to the adjacent artery.
  \end{itemize}
\item
