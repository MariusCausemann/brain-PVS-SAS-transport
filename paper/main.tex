...
network. In the baseline model, we account for cardiac peristalsis and set $\hat{u}$ as $\hat{u}_a = \hat{u}_a^c$ in $\Lambda_a$, and $\hat{u}_v =
0$ in $\Lambda_v$. We remark that none of these models
