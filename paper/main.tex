...
represented as a graph with nodes connected by edges. The nodes with
lowest z-coordinate are identified as the networks' root nodes. We
denote the domain defined by the connected centerlines by
