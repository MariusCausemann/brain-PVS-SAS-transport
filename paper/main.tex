...
\begin{table}
  ...
  \begin{tabular}{ll|lll|lll}
    ...
    2 & reduced CSF pulsatility & $\bm u_{\rm CSF}$ & $\hat{u}_a^p + \hat{u}_a^c$ & $\hat{u}_v^p$  & \blue{$ R_{\rm red}$} & $\xi_{\rm EF}$ & $2 R_1$  \\ 
    3 & increased CSF pulsatility & $\bm u_{\rm CSF}$ & $\hat{u}_a^p + \hat{u}_a^c$ & $\hat{u}_v^p$  & \blue{$R_{\rm inc}$} & $\xi_{\rm EF}$ & $2 R_1$  \\ 
  ...
  \caption{Overview of model variations, with color highlighting
    ...
    variations $R_{\rm red}$ and $R_{\rm inc}$ corresponding to
