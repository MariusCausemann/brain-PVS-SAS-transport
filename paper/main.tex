...
upstream network ends within the SAS or just inside the parenchyma
(\Cref{fig:results1}A--C, \Cref{fig:results3}A) and includes major
surface arteries of radius \discuss{$0.5-1.3$ mm}
(\Cref{fig:results3}C). Imposing the pressure field induced by CSF
production at the periarterial network ends induces ultraslow flow of
CSF in the PVS, with an average velocity of 0.08 $\mu$m/s and a
maximum velocity of 0.55 $\mu$m/s (\Cref{fig:results3}D, H)
