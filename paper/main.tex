...
While molecular enrichment of the brain and surrounding CSF spaces has
been extensively studied in animal models, especially in murine models
in connection with studies of the glymphatic system, there are much
fewer reports of contrast enrichment in human subjects; we therefore
mainly compare our in-silico predictions with the series of papers by
Eide and colleagues~\cite{ringstad2017glymphatic, ringstad2018brain,
  eide2021sleep, eide2024functional} and Yamamoto et
al.~\cite{yamamoto2024perivascular}. 

Tracer enrichment timings compared with~\cite{eide2024functional,
  yamamoto2024perivascular}.  Tracer enrichment patterns compared with
\cite{ringstad2017glymphatic, ringstad2018brain, eide2021sleep},

% Effect of PVS size and dilation. As well as interfaces.
