...
function. \textcolor{lightgray}{Understanding and predicting molecular
  enrichment is important for treatment and diagnostics of (brain)
  cancer. The context of understanding clearance in connection with
  neurodegenerative disease and for future treatment and diagnostics
  of dementia disorders. Moreover, altered transport and clearance is
  believed to be key factor in neurodegenerative diseases like
  Alzheimer's disease and Parkinson's disease, and in sleep. For
  diagnostics of CSF-related disorders like normal pressure
  hydrocephalus, subarachnoid hemorrage.} In the last decade,
...
exchange~\cite{iliff2012paravascular, ringstad2017glymphatic,
  ...
  bohr2022glymphatic} in combination with substantial variability in
...
cohorts~\cite{ringstad2018brain, eide2021direction, eide2021impaired,
  eide2022altered}. \textcolor{lightgray}{This provides distinct
  opportunities and challenges in particular in the context of
  personalized medicine. In spite of their importance, our
  understanding of these mechanisms is incomplete with open questions
  relating to the transfer of knowledge between species, experiments,
  cohorts, individual variations, therefore important in particular in
...
subtypes~\cite{eide2024functional}. Perivascular flow of CSF clearly
...
impair) human intracranial molecular transport over larger or longer
...
In this study, ... \textcolor{lightgray}{\lipsum[2]}
