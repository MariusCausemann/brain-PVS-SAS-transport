...
\begin{abstract}
  ...
  resonance images, and high performance computing to construct a
  computational framework for molecular transport within the human
  intracranial space. The model predicts the spatiotemporal spreading
  of a solute within an image-derived representation of the
  subarachnoid space, ventricular system and brain parenchyma. A key
  feature is the explicit representation of surface perivascular
  spaces (PVSs). To illustrate applicability, we simulate a series of
  scenarios relating to intrathecal tracer injections, including
  variations in cerebrospinal fluid (CSF) production and intracranial
  pulsatility, perivascular fluid flow, and structural properties of
  the PVS. This openly available framework thus allows for evaluating
  the integrated effect of different transport mechanisms, bridging
  from the vascular mesoscale to the organ-level macroscale and across
