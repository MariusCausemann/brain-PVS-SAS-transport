...
Perivascular pathways have long been hypothesized to play a special
role, both within the SAS along the brain surface and within the brain
parenchyma~\cite{rennels1985evidence, zhang1990interrelationships,
  ichimura1991distribution, hadaczek2006perivascular,
...
al~\cite{yamamoto2024perivascular} show that PVSs define preferential
pathways for molecular transport also in humans. Flow of CSF
contributes to perivascular transport, and is clearly associated with
arterial pulsations in synchrony with the cardiac
cycle~\cite{iliff2013cerebral, bedussi2018paravascular, mestre2018flow, boster2023artificial}.%~\cite{hadaczek2006perivascular}?
