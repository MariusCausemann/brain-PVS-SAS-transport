...
\begin{figure}
    ...
    \caption{\textbf{Does early appearance of tracer in the PVS rely on a structural compartmentalization of the PVS?}
...
\subsection*{Will dilated PVSs in the SAS impact the intracranial tracer distribution?}
...
To address this question from a fluid and transport dynamics
perspective, we consider a final model variation in which we examine
the predicted effect of perivascular dilation on perivascular flow velocities
and tracer distribution patterns (\Cref{fig:enlargement}A). We again
compute cardiac and vasomotion-induced net perivascular flow velocities, but
now in a periarterial geometry with an increased outer radius ($R^{\rm
