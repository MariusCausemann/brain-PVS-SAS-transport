...
For an extended description of the mathematical model and simulation
scenarios, see the Supplementary information S1.
...
\begin{table}
  \begin{center}
    \begin{tabular}{ll|ccc}
      ...
      Molecular efflux rate & $\beta_{\rm exit}$ & $8\cdot 10^{-7}$ & m/s & \cite{hornkjol2022csf} \\
      ...
      CSF outflow resistance & $R_0$ & $10^{4}$  & Pa$\cdot$s/m & \cite{hornkjol2022csf} \\ 
