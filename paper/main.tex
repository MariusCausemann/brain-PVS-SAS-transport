...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{figures/csf_v_prod.png}
...
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{figures/csf_v_respiratory.png}
\includegraphics[width = 1 \textwidth]{figures/resp_velocity_histo.png} 
\caption{CSF flow  from respiratory pulsatility}
\label{fig:csf_flow_respiratory}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{figures/R_cardiac.png} 
\caption{Cardiac dispersion enhancement factor}
\label{fig:csf_flow_R_cardiac}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{figures/R_respiratory.png} 
\caption{Respiratory dispersion enhancement factor}
\label{fig:csf_flow_R_respiratory}
\end{subfigure}
\begin{subfigure}[b]{0.33\textwidth}
\includegraphics[width = 1 \textwidth]{figures/cardiac_R_histo.png}
\includegraphics[width = 1 \textwidth]{figures/respiratory_R_histo.png} 
...
Moreover, we model the \discuss{pia} membrane as a semi-permeable membrane with
