...
enlarged PVSs in the SAS. In our simulations, the balance
between CSF production and intracranial pulsatility significantly
affects tracer distribution patterns at the macroscale, with
...
pathways, even moderate net flow on the order of 0.1--1.0 \textmu m/s
in the surface PVSs results in earlier appearance of tracer around
major cerebral arteries in our model scenarios. This effect is more
...
antegrade and retrograde flow within the periarterial network. In our
simulations, the PVSs thus function as highways facilitating rapid
transport, even in the absence of tight structural barriers.
...
individual variation observed clinically. In our simulations, about
...
Our simulation results are compatible with the concept that intracranial
tracer transport relies one or more mechanisms in addition to CSF
...
\cite{asgari2016glymphatic,sharp2019dispersion,bojarskaite2023sleep,asgari2016glymphatic,troyetsky2021dispersion}. Moreover, the effective diffusion is generally reduced in conduits with permeable compared to non-permeable walls, see e.g.~\cite{decuzzi2006effective, dejam2021role} and references therein. In
our model, not even a 100-fold increase in the PVS dispersion
coefficient accelerates transport substantially
(\Cref{fig:high_low_pvs}H). To illustrate the need for a stronger
