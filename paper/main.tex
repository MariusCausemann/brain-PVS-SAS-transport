...
plexues with CSF efflux across the upper
...
(\Cref{fig:results1}E--G). One hour post-injection, the in-sillico
...
posteriorly through the quadrigeminal cistern and the longitudinal
...
\item
  Not all of the injected tracer get to the craniocerival
