...
with an average velocity of 0.08 $\mu$m/s (antegrade) and a maximum
velocity of 0.55 $\mu$m/s (\Cref{fig:pvs}B). On the other hand,
...
flow with an average net velocity of 0.92 $\mu$m/s while reaching up
to 7.31 $\mu$m/s near larger, ventral vessels such as the MCA
...
13.05 $\mu$m/s and maximum velocity $54.44$ $\mu$m/s
(\Cref{fig:pvs}E).
...
1:48h at MCA2) with high PVS flow, while these peaks occured nearly
