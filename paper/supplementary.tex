...
\title{\textcolor{black}{Supplementary information for In-silico molecular transport via perivascular networks in the human intracranial space}}
...
\begin{abstract}
  ...
  \emph{\textcolor{blue}{In-silico molecular transport via perivascular networks in the human intracranial space}}.
\end{abstract}
...
\begin{figure}
    ...
    \caption{
      A) Peak CSF flow induced by cardiac pulsatlity; 
      B) Peak CSF flow induced by respiratory pulsatlity; 
