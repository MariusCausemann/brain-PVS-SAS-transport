...
\begin{figure}
    ...
    G+H) sagittal, coronal and axial view of in-silico tracer concentrations overlayed on T1-weighted MR image after 9, 12, and 24\,h (low concentrations transparent, pial surface in pink, arachnoid membrane in cyan, and arteries in dark red) for the model with 0D compartments (G) and without (H).
    }
    \label{fig:0D_xi_multiplier_comparison}
\end{figure}
