...
\begin{equation}
  \hat{D}A \partial_{n} \hat{c} - (A \hat{u} \cdot n) \hat{c} = 0 \quad \mathrm{for} \quad y_k \in \mathcal{N} \setminus \mathcal{N}_{\rm leaf}.
  \label{eq:1d_noflux}
\end{equation}
