...
\vspace{-1em}
  \begin{tikzpicture}
  [scale=0.7, background rectangle/.style={fill=black}, show background rectangle]
  ...
  \draw[ ultra thick, white ] (n3) -- (n2);% node[right]{$ \bf x$};
  \draw[ ultra thick, white ] (n2) -- (n1);
  \draw[ ultra thick, white ] (n0) -- (n1);

  \draw[ very thick, white ] (n2) -- (n4);
  \draw[ very thick, white ] (n4) -- (n5);
  \draw[ thick, white ] (n4) -- (n6);
  \draw[ thick, white ] (n6) -- (n7);

  \draw[ very thick, white ] (n1) -- (n8);
  \draw[ very thick, white ] (n8) -- (n9);

  \draw[ thick, white ] (n9) -- (n10);
  \draw[ thick, white ] (n10) -- (n14);

  \draw[ thick, white ] (n9) -- (n13);

  \draw[ very thick, white ] (n9) -- (n11);
  \draw[ very thick, white ] (n11) -- (n12);
  \draw[ very thick, white ] (n12) -- (n15);
...
\begin{tikzpicture}
  ...
  \draw[ thick, dotted, white ] (n9) -- (n13);
...
\begin{tikzpicture}
  ...
  \draw[-stealth, ultra thick, white ] (n3) to  [bend right=20] (n4) ;
  \draw[-stealth, very thick, white ] (n4) -- (n5);
  \draw[-stealth, thick, white ] (n4) to [bend right=20] (n7);
  ...
  \draw[-stealth, ultra thick, white ] (n0) to [bend left=10] (n9);
  \draw[-stealth, thick, white ] (n9) -- (n14);
  \draw[-stealth, very thick, white ] (n9) to [bend right=10] (n15);
\end{tikzpicture}
  \end{subfigure}
  \begin{subfigure}{0.19\textwidth}
%\caption*{\bf D}
