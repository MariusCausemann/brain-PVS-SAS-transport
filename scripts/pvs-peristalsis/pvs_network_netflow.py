"""This script implements the computation of a theoretical estimate
for the directional (net) flow induced by a peristaltic wave in a
perivascular network. 

The derivation of the general estimate and special case networks is
presented in:

  Gjerde, Rognes, and Sánchez, "The directional flow generated by
  peristalsis in perivascular networks — Theoretical and numerical
  reduced-order descriptions", Journal of Applied Physics 134.17
  (2023) https://doi.org/10.1063/5.0160334.
