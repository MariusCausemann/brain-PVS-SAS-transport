...
// ---------------------------------------------------------
    ...
    grid(
      ...
      [
        ...
        #v(-10pt)
        #image("../plots/modelA-strongVM/modelA-strongVM_total_conc.svg", width: 100%)
      ],
      [
        #panel-label("B") #v(-15pt) 
        #panel-title("Tracer content (without 0D model)", fontsize: titlefontsize)
        #v(-10pt)
        #image("../plots/modelA-strongVM-root100/modelA-strongVM-root100_total_conc.svg", width: 100%)
      ],
      [
        #panel-label("C") #v(-15pt) 
        #panel-title("0D concentrations (0D model)", fontsize: titlefontsize)
        #crop-image("../plots/modelA-strongVM/modelA-strongVM_tip_conc.svg",0pt,0pt,13pt,0pt)
...
// ---------------------------------------------------------
    ...
    grid(
      ...
      [
        ...
        #v(-5pt)
        #image("../plots/comparisons/modelA-strongVM_modelA-strongVM-root100/modelA-strongVM_modelA-strongVM-root100_fta.svg", width: 100%)
      ],
      ...
      grid(
        ...
        [
          ...
          #v(-12pt)
          #crop-image("../plots/modelA-strongVM/modelA-strongVM_leaf_conc.svg",0pt,0pt,13pt,0pt)
        ],
        [
          #v(-15pt)
          #panel-label("E")
          ...
          #v(-12pt) 
          #image("../plots/modelA-strongVM-root100/modelA-strongVM-root100_leaf_conc.svg", width: 100%)
